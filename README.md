...
### Branch
Определяет покрытие ветвей для операторов if и switch. Этот счетчик подсчитывает общее количество таких ветвей в методе 
...
### [TASK](https://github.com/netology-code/javaqa-homeworks/tree/master/ci)
1. Выбрать любой счетчик JaCoCo и добиться 100% покрытия тестами.
1. Подключить плагин CheckStyle, CI должен падать.

### TOOLS
Java, JUnit Jupiter, Maven, JaCoCo, CheckStyle
